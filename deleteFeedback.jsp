...
%>
<div class="delete">
<h1>Customer Feedback Delete</h1><br><br>
<div class="m">
<form method="post" action="delete" >
				            ...
				            <input type="text" name="full_name" class="input" value="<%=full_name %>"readonly ><br><br>
				
				            <label class="topic2">Email Address</label><br> 
				            <input type="email" name="email"  class="input" value="<%=email%>"readonly><br><br>
				                                
				            <label class="topic2">Phone Number</label><br>
				            <input type="text" name="phone_number"  class="input" value="<%=phone_number %>"readonly><br><br>
				                                
				            <label class="topic2">Date</label><br>
				            <input type="date" name="date"  class="date" value="<%=date%>"readonly><br><br>
				
				            <label class="topic2">Describe your feedback</label><br>
				            <textarea class="addres" name="comment" value="<%=comment %>" rows="3" cols="40" placeholder="Write Something Here......!"readonly></textarea><br><br><br>
